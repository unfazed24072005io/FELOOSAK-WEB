          ...
          <div className="nav-links" style={{ display: "flex", alignItems: "center", gap: 32 }}>
            {["Product", "Solutions", "Pricing", "About"].map(l => (
              <a key={l} href={`#${l.toLowerCase()}`} style={{ textDecoration: "none", color: "#6B6560", fontSize: 14, fontWeight: 500, transition: "color 0.2s" }}
                onMouseEnter={e => (e.target as HTMLElement).style.color = "#1A1A1A"} onMouseLeave={e => (e.target as HTMLElement).style.color = "#6B6560"}>{l}</a>
            ))}
            <button onClick={onGoToLogin} style={{ background: "none", border: "2px solid #E0DDD6", padding: "8px 20px", borderRadius: 12, fontSize: 13, fontWeight: 600, cursor: "pointer", color: "#1A1A1A", transition: "all 0.3s" }}>Sign In</button>
      ...
      <section style={{ position: "relative", padding: "160px 24px 100px", maxWidth: 1200, margin: "0 auto", textAlign: "center", overflow: "hidden" }}>
        ...
        <FadeIn delay={0.3}>
          <div style={{ display: "flex", justifyContent: "center", gap: 14, flexWrap: "wrap", marginBottom: 48 }}>
            <button onClick={onGoToLogin} className="btn-primary" style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div key={i}>
                ...
                {col.links.map(l => (
                  <a key={l} href="#" style={{ display: "block", fontSize: 14, color: "#6B6560", textDecoration: "none", marginBottom: 10, transition: "color 0.2s" }}
                    onMouseEnter={e => (e.target as HTMLElement).style.color = "#fff"} onMouseLeave={e => (e.target as HTMLElement).style.color = "#6B6560"}>{l}</a>
                ))}
              </div>
            ))}
          </div>
